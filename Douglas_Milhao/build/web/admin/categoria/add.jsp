            ...
            <form action="add-ok.jsp" method="post">
                ...
                <div class="mdl-cell--12-col"> 
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" name="txtNomeCategoria" required  id="txtNomeCategoria" />
                        <label class="mdl-textfield__label" for="txtNomeCategoria">Nome</label>
                    </div>
                </div>
