...
CASO NÃO RODAR, EU TROQUEI O ID_JOGADOR DO UPDATE
-->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="ttupd" class="icon material-icons">
                                <i class="material-icons"><a href="upd.jsp?LoginJogador=<%=j.getLogin()%>">update</a></i>
                            </div>
                            ...
                            <div id="ttdel" class="icon material-icons">
                                <i class="material-icons"><a href="del-ok.jsp?LoginJogador=<%=j.getLogin()%>">delete</a></i>
                            </div>
